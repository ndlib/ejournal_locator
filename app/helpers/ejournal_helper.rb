module EjournalHelper
  def findtext_url(document)
    ...
    # "https://findtext.library.nd.edu/ndu_local?url_ver=Z39.88-2004&ctx_ver=Z39.88-2004&ctx_enc=info:ofi/enc:UTF-8&rfr_id=info:sid/ND_ejl_loc&url_ctx_fmt=info:ofi/fmt:kev:mtx:ctx&svc_val_fmt=info:ofi/fmt:kev:mtx:sch_svc&sfx.ignore_date_threshold=1&rft.object_id=#{object_id}"
    "https://findtext.library.nd.edu/ndu_local?ctx_ver=Z39.88-2004&ctx_enc=info:ofi/enc:UTF-8&url_ver=Z39.88-2004&url_ctx_fmt=infofi/fmt:kev:mtx:ctx&rfr_id=info:sid/primo.exlibrisgroup.com:primo3-Journal-ndu_aleph&rft_val_fmt=info:ofi/fmt:kev:mtx:journal&rft.genre=journal&rft.object_id=#{object_id}"
  end
